...
## Task 8: Implement AVX2 Scale Shuffle Helpers
...
## Task 9: Implement AVX2 Dot Product
...
## Task 11: Integrate into Dispatch
...
pub use kernels::gemm_q4k_q8::gemm_q4_k_q8_k_dispatch_gemm;
...
## Task 12: Implement AVX2 GEMM Wrapper
...
///
/// Note: Named `dispatch_gemm` to distinguish from `gemv_q4_k_q8_k_dispatch`.
...
GgmlType::Q4_K => {
    ...
    if meta.needs_transpose {
        ...
        gemm_q4_k_q8_k_dispatch_gemm(w, x, y, m, out_dim, in_dim);
    }
    Ok(())
}
```

Note: We use `gemm_q4_k_q8_k_dispatch_gemm` to distinguish from the GEMV dispatch function.
...
## Task 13: Create Benchmark Suite
...
## Task 16: Verify Performance Targets
