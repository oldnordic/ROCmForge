...
// NOTE: E8M0 and MxfpBlock are now imported from crate::loader::mxfp
// to avoid code duplication. The duplicate definitions have been removed.
// See: .planning/phases/23-dead-duplicate-code-removal/23-01-PLAN.md
