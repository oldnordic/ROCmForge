//! Q4_0 quantization kernel (CPU + GPU)
//!
//! Q4_0 format: 4-bit quantization with constant scale
//! - Block size: 32 elements
//! - Per block (20 bytes): 4 bytes scale + 16 bytes packed 4-bit values
...
/// Dequantize Q4_0 weights to f32 (CPU-only version)
///
...
///
/// # Q4_0 CPU Reference Implementation
///
/// Q4_0 format details:
/// - Block: 32 elements in 20 bytes
/// - Scale layout: 4 bytes (f32) at block start
/// - Quant layout: 16 bytes of packed 4-bit values
