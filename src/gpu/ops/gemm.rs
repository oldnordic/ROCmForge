...
pub fn gpu_dispatch_gemm(
    ...
    Err(GpuError::UnsupportedOperation {
        ...
        reason: "GEMM kernel not implemented for this quant type. Use GEMV (seq_len=1) for now.".to_string(),
    })
}
